...
class PitchAssistant:
    ...
    def fin_metrics(
        ...
        Класс 1 - Бизнес относится к "ИТ-услуги"
        Класс 2 - Бизнес относится к "ПО"
        Класс 3 - Бизнес относится к "Производство промышленного оборудования"
        Класс 4 - Бизнес относится к "Финансовый сектор услуг"
        Класс 5 - Бизнес относится к "Профессиональные услуги: бухгалтерские, юридические, инженерные и т.д.""
        Класс 6 - Бизнес относится к "Телекоммуникации"
        Класс 7 - Бизнес относится к "Производство товаров"
        Класс 8 - Бизнес относится к "Транспорт и перевозки"
        Класс 9 - Бизнес относится к "Производство потребительских товаров"
        Класс 10 - Бизнес относится к "Оптовая торговля"
